...
- (void)hasIntForeignKeyColumn:(NSString *)name nameTableLink:(NSString*) nameTable nameForeignKey:(NSString*) nameForeignKey{
     FMXColumnMap *column = [[FMXColumnMap alloc] initWithName:name type:FMXColumnMapTypeInt nameTableLink:nameTable nameForeignKey:nameForeignKey];
    [self.columns setObject:column forKey:name];
}

- (void)hasLongForeignKeyColumn:(NSString *)name nameTableLink:(NSString*) nameTable nameForeignKey:(NSString*) nameForeignKey{
    FMXColumnMap *column = [[FMXColumnMap alloc] initWithName:name type:FMXColumnMapTypeLong nameTableLink:nameTable nameForeignKey:nameForeignKey];
    [self.columns setObject:column forKey:name];
}
